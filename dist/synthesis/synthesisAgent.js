 ...
 */
function calcRawRecommendation(netScore) {
    if (netScore > 0.8)
        return 'buy';
    if (netScore > 0.3)
        return 'add';
...
export async function synthesize(marketOutput, sentimentOutput, ragOutput, userProfile) {
    ...
    let recommendation = calcRawRecommendation(netScore);
