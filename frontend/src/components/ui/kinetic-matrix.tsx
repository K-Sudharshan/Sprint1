...
export function KineticMatrix({
    ...
    return (
        <div
            ...
            className={cn(
                "group relative flex h-full w-full select-none flex-col justify-between overflow-hidden bg-[#06070a]",
                className
            )}
        >
            ...
            <div className="relative z-20 flex h-full w-full flex-col justify-between p-6 md:p-10">
                {/* Top Header Deck */}
                <header className="flex w-full items-center justify-between font-mono text-[11px] text-neutral-400">
                    <div className="flex items-center gap-2">
                        <button
                            onClick={triggerCentralImpulse}
                            className="flex items-center gap-1.5 rounded-lg border border-neutral-800 bg-neutral-900/70 px-2.5 py-1.5 backdrop-blur-md transition-all hover:bg-neutral-800 text-neutral-200"
                ...
                <main className="pointer-events-none flex flex-col items-center justify-center text-center">
                    <h1 className="font-mono text-5xl font-black tracking-tighter uppercase sm:text-7xl md:text-9xl text-white opacity-20">
                        {title}
                    </h1>
                </main>
